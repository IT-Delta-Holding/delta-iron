...
function tech_news_filter_ajax()
{
...
add_action('wp_ajax_tech_news_filter_ajax', 'tech_news_filter_ajax');
add_action('wp_ajax_nopriv_tech_news_filter_ajax', 'tech_news_filter_ajax');
